...
POSE_RESNET.HEATMAP_SIZE = [80, 80]  # width * height, ex: 24 * 32
POSE_RESNET.SIGMA = 2
...
config.MODEL.NUM_JOINTS = 22
config.MODEL.IMAGE_SIZE = [320, 320]  # width * height, ex: 192 * 256
...
def update_config(config_file):
    ...
    with open(config_file) as f:
        exp_config = edict(yaml.load(f, Loader=SafeLoader))
