...
class COCODataset(JointsDataset):
    def __init__(self, cfg, root, image_set, is_train, transform=None):
        ...
        # todo : 
        # 1. change num_keypoints
        # optional) if you want to use flip augmentation, specify keypoint pairs corresponding to num_joint number.
        self.num_joints = 22
    ...
    def image_path_from_index(self, index):
        ...
        image_path = os.path.join(
            self.root, self.image_set, file_name)

        return image_path

    def image_id_from_path(self, path):
        img_num = None
    ...
    def evaluate(self, cfg, preds, output_dir, all_boxes, img_path, imgnums,
                 *args, **kwargs):
        ...
        for idx, kpt in enumerate(preds):
            ...
            _kpts.append({
                ...
                'image': self.image_id_from_path(img_path[idx])
            })
